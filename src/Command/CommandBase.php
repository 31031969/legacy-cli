...
abstract class CommandBase extends Command implements MultiAwareInterface
{
     ...
     */
    protected function addResourcesInitOption($values = ['default', 'parent', 'minimum', 'manual'])
    {
        ...
        if ($values) {
            ...
            $formattedDefault = $default . ($default !== 'default' ? ' (default)' : '');
            $description .= ': ' . StringUtil::formatItemList(array_merge([$formattedDefault], $values));
        }
